...
//		selectReparo(c);
	...
	private static void selectPeca(ConexaoBD c) throws SQLException{
		...
		while(result.next()){
	    	...
	    	System.out.println(result.getString("categoria"));
	    	System.out.println(result.getInt("id_fabricante"));
	    	System.out.println("");
	    }
	}
	...
	private static void selectReparo(ConexaoBD c) throws SQLException{
		...
		while(result.next()){
			...
			System.out.println(result.getString("descricao_detalhada"));
	    	System.out.println("");
	    }
	}
	...
	private static void selectEstoque(ConexaoBD c) throws SQLException{
		...
		while(result.next()){
			System.out.println(result.getString("codigo_peca")+" - "+result.getInt("quantidade"));
	    }
	}
	...
	private static void selectParcelas(ConexaoBD c, Integer idPagamento) throws SQLException{
		...
		while(result.next()){
			System.out.println(result.getInt("id"));
			System.out.println(result.getDouble("valor"));
			System.out.println(result.getBoolean("paga"));
			System.out.println(result.getDate("data_vencimento"));
			System.out.println(result.getInt("id_pagamento"));
	    	System.out.println("");
	    }
	}
